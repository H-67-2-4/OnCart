...
import com.example.groccers.Constants;
...
public class AddProductActivity extends AppCompatActivity {
    ...
    private void addProduct() {
        ...
        if(image_uri == null){
            ...
            hasMap.put("productId",""+timestamp);
            hasMap.put("productTitle",""+productTitle);
            hasMap.put("productDescription",""+productDescription);
            hasMap.put("productCategory",""+productCategory);
            hasMap.put("productQuantity",""+productQuantity);
            hasMap.put("productIcon","");  // no image, set empty
            hasMap.put("originalPrice",""+originalPrice);
            hasMap.put("discountPrice",""+discountPrice);
            hasMap.put("discountNote",""+discountNote);
            hasMap.put("discountAvailable",""+discountAvailable);
            hasMap.put("timestamp",""+timestamp);
            hasMap.put("uid",""+firebaseAuth.getUid());
            //add to db
            DatabaseReference reference = FirebaseDatabase.getInstance().getReference("Users");
            reference.child(firebaseAuth.getUid()).child("Products").child(timestamp).setValue(hasMap)
                    ...
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            if(uriTask.isSuccessful()){
                                ...
                                hasMap.put("productCategory",""+productCategory);
                                hasMap.put("productQuantity",""+productQuantity);
                                hasMap.put("productIcon",""+downloadImageUri);
                                hasMap.put("originalPrice",""+originalPrice);
                                hasMap.put("discountPrice",""+discountPrice);
                                hasMap.put("discountNote",""+discountNote);
                                hasMap.put("discountAvailable",""+discountAvailable);
    ...
    private void clearData(){
        ...
        productIconIv.setImageResource(R.drawable.ic_add_shopping_orange);
        image_uri = null;
    }
